...
const _MsScrollbar3dlightColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ msScrollbar3dlightColor: Method.hexa(code, alpha) }),
...
const _MsScrollbarArrowColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ msScrollbarArrowColor: Method.hexa(code, alpha) }),
...
const _MsScrollbarBaseColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ msScrollbarBaseColor: Method.hexa(code, alpha) }),
...
const _MsScrollbarDarkshadowColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ msScrollbarDarkshadowColor: Method.hexa(code, alpha) }),
...
const _MsScrollbarFaceColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ msScrollbarFaceColor: Method.hexa(code, alpha) }),
...
const _MsScrollbarHighlightColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ msScrollbarHighlightColor: Method.hexa(code, alpha) }),
...
const _MsScrollbarShadowColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ msScrollbarShadowColor: Method.hexa(code, alpha) }),
...
const _MsScrollbarTrackColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ msScrollbarTrackColor: Method.hexa(code, alpha) }),
...
const _MozBorderBottomColors = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ mozBorderBottomColors: Method.hexa(code, alpha) }),
...
const _MozBorderLeftColors = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ mozBorderLeftColors: Method.hexa(code, alpha) }),
...
const _MozBorderRightColors = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ mozBorderRightColors: Method.hexa(code, alpha) }),
...
const _MozBorderTopColors = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ mozBorderTopColors: Method.hexa(code, alpha) }),
...
const _WebkitTapHighlightColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ webkitTapHighlightColor: Method.hexa(code, alpha) }),
...
const _WebkitTextFillColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ webkitTextFillColor: Method.hexa(code, alpha) }),
...
const _WebkitTextStroke = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ webkitTextStroke: Method.hexa(code, alpha) }),
...
const _WebkitTextStrokeColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ webkitTextStrokeColor: Method.hexa(code, alpha) }),
...
const _BackgroundColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ backgroundColor: Method.hexa(code, alpha) }),
...
const _Border = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ border: Method.hexa(code, alpha) }),
...
const _BorderBottom = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderBottom: Method.hexa(code, alpha) }),
...
const _BorderBottomColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderBottomColor: Method.hexa(code, alpha) }),
...
const _BorderColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderColor: Method.hexa(code, alpha) }),
...
const _BorderLeft = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderLeft: Method.hexa(code, alpha) }),
...
const _BorderLeftColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderLeftColor: Method.hexa(code, alpha) }),
...
const _BorderRight = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderRight: Method.hexa(code, alpha) }),
...
const _BorderRightColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderRightColor: Method.hexa(code, alpha) }),
...
const _BorderTop = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderTop: Method.hexa(code, alpha) }),
...
const _BorderTopColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ borderTopColor: Method.hexa(code, alpha) }),
...
const _BoxShadow = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ boxShadow: Method.hexa(code, alpha) }),
...
const _CaretColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ caretColor: Method.hexa(code, alpha) }),
...
const _Color = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ color: Method.hexa(code, alpha) }),
...
const _ColumnRule = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ columnRule: Method.hexa(code, alpha) }),
...
const _ColumnRuleColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ columnRuleColor: Method.hexa(code, alpha) }),
...
const _Outline = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ outline: Method.hexa(code, alpha) }),
...
const _OutlineColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ outlineColor: Method.hexa(code, alpha) }),
...
const _TextDecoration = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ textDecoration: Method.hexa(code, alpha) }),
...
const _TextDecorationColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ textDecorationColor: Method.hexa(code, alpha) }),
...
const _TextEmphasis = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ textEmphasis: Method.hexa(code, alpha) }),
...
const _TextEmphasisColor = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ textEmphasisColor: Method.hexa(code, alpha) }),
...
const _TextShadow = {
    ...
    hexa: (code: string, alpha: number): Sheet => ({ textShadow: Method.hexa(code, alpha) }),
